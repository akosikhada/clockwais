    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/30">
        ...
        <div className="space-y-5">
          <div className="flex justify-between items-center p-3 rounded-xl bg-primary/10 border border-pink-100">
          ...
          <div className="flex justify-between items-center p-3 rounded-xl bg-secondary/10 border border-blue-100">
            <div className="flex items-center gap-3">
          ...
          <div className="flex justify-between items-center p-3 rounded-xl bg-accent/10 border border-pink-100">
            <div className="flex items-center gap-3">
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/30">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="w-8 h-8 rounded-xl bg-secondary/20 flex items-center justify-center cursor-pointer hover:shadow-lg transition-all duration-300 button-hover border border-pink-200">
        ...
        <div className="grid grid-cols-7 gap-1">
          ...
          {calendarDays.map((day, index) => {
            if (React.isValidElement(day) && (day.props as any).children) {
              const dayNumber = (day.props as any).children;
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isToday
                      ? "bg-primary text-white font-bold shadow-lg glow-effect"
                      : isHighlighted
                        ? "bg-secondary text-white font-bold shadow-md"
                        : "hover:bg-muted text-slate-600 hover:text-slate-800 hover:shadow-sm"
                  )}
                >
                  {dayNumber}
                </div>
